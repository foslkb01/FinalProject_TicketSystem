...
namespace FinalProject_TicketSystem {
    ...
    public partial class TicketsDataSet : global::System.Data.DataSet {
        ...
        public partial class TicketsDataTable : global::System.Data.TypedTableBase<TicketsRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public TicketsRow AddTicketsRow(string Name, double Phone, string Email, string Location, System.DateTime Date, int Priority, string Description) {
...
namespace FinalProject_TicketSystem.TicketsDataSetTableAdapters {
    ...
    public partial class TicketsTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[Tickets] WHERE (([Id] = @Original_Id) AND ([Name] = @Original_Name) AND ([Phone] = @Original_Phone) AND ([Email] = @Original_Email) AND ([Location] = @Original_Location) AND ([Date] = @Original_Date) AND ([Priority] = @Original_Priority))";
...
SELECT Id, Name, Phone, Email, Location, Date, Priority, Description FROM Tickets WHERE (Id = @Id)";
        ...
        public virtual int Delete(int Original_Id, string Original_Name, double Original_Phone, string Original_Email, string Original_Location, System.DateTime Original_Date, int Original_Priority) {
        ...
        public virtual int Insert(string Name, double Phone, string Email, string Location, System.DateTime Date, int Priority, string Description) {
            if ((Name == null)) {
        ...
        public virtual int Update(string Name, double Phone, string Email, string Location, System.DateTime Date, int Priority, string Description, int Original_Id, string Original_Name, double Original_Phone, string Original_Email, string Original_Location, System.DateTime Original_Date, int Original_Priority, int Id) {
            if ((Name == null)) {
                throw new global::System.ArgumentNullException("Name");
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Name, double Phone, string Email, string Location, System.DateTime Date, int Priority, string Description, int Original_Id, string Original_Name, double Original_Phone, string Original_Email, string Original_Location, System.DateTime Original_Date, int Original_Priority) {
            return this.Update(Name, Phone, Email, Location, Date, Priority, Description, Original_Id, Original_Name, Original_Phone, Original_Email, Original_Location, Original_Date, Original_Priority, Original_Id);
        }
    }
